...
public final class WorkflowParser {
     ...
     * Parse a DAX file with jdom
     */
    public double[][] parseXmlFileTest(String path) {
        ...
        try {
            ...
            for(int i = 0; i < length; i++){
            	points[i][0] = getTaskList().get(i).getCloudletLength();
            	//System.out.println("double : "+points[i][0]+"  long : "+getTaskList().get(i).getCloudletLength());
            	points[i][1] = filesize.get(i);
            	//System.out.println("double : "+points[i][1]+"  long : "+filesize.get(i));
            }
